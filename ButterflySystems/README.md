#### There are two versions of Apis, v1 and v2. A normal approach has been implemented in the version 1 and in the version 2, strategy and factory patterns have been used to implement the calculator. 
